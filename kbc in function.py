...
def func_name(option):
    ...
    while j<len(option):
        ...
        while k<(len(option)+1):
            ...
            k+=1
        j+=1
        user=input("want lifeline or not enter yes/no")
        if user=="yes":
            
# option=[["four","nine","seven","eight"],["chandigarh","bhopal","chennai","delhi"],["software engineering","couselling","tourism","agriculture"]]
# func_name(option)
ques=["how many continent are there","what is the capital of india","what are we doing in ng"]
func(ques)
option=[["four","nine","seven","eight"],["chandigarh","bhopal","chennai","delhi"],["software engineering","couselling","tourism","agriculture"]]
